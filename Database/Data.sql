...
VALUES 
(3, 'headline', 'text', 'Train the Brain. Play Insane. Own the Game', 1, 1),
(3, 'subhead', 'text', 'Your success is ours', 1, 1),
(3, 'cta-text', 'text', 'LEARN MORE', 1, 1),
(3, 'background-image', 'text', '1', 1, 1); -- References Media ID 1

-- Insert Content for Whats New Carousel Section (Section ID = 2)
-- Using JSON approach for cleaner carousel management
INSERT INTO Content (SectionId, ContentKey, ContentType, Value, IsActive, CreatedBy) 
VALUES 
(4, 'section-title', 'text', 'WHAT''S NEW WITH C3FC Soccer', 1, 1),
(4, 'carousel-slides', 'json', 
'[
  {
    "imageId": 4,
...
INSERT INTO Content (SectionId, ContentKey, ContentType, Value, IsActive, CreatedBy) 
VALUES 
(5, 'headline', 'text', 'Redefining the Youth Soccer Experience in Houston', 1, 1),
(5, 'content', 'html', '<p>A full-service soccer club, our programming serves players from the recreational to elite level. With community at its core, C3FC Soccer focuses on growth, learning, and high-level player development.</p>', 1, 1),
(5, 'cta-text', 'text', 'ABOUT C3FC Soccer', 1, 1),
(5, 'cta-link', 'text', '/about', 1, 1),
(5, 'image', 'text', '2', 1, 1); -- References Media ID 2

-- Insert Content for Player Development Section (Section ID = 4)
INSERT INTO Content (SectionId, ContentKey, ContentType, Value, IsActive, CreatedBy) 
VALUES 
(6, 'headline', 'text', 'Developing Players At Every Level', 1, 1),
(6, 'content', 'html', '<p>C3FC Soccer develops youth soccer players through professional coaching and inspiring environments. Learn about our programs:</p>', 1, 1),
(6, 'programs-list', 'json', '["Recreational", "Youth Academy", "Competitive"]', 1, 1),
(6, 'image', 'text', '3', 1, 1); -- References Media ID 3

-- Insert Content for Partners Section (Section ID = 5)
-- Using JSON approach for partner carousel
INSERT INTO Content (SectionId, ContentKey, ContentType, Value, IsActive, CreatedBy) 
VALUES 
(7, 'section-title', 'text', 'We''re proud of the support of our partners', 1, 1),
(7, 'cta-text', 'text', 'Become a Partner', 1, 1),
(7, 'cta-link', 'text', '/become-partner', 1, 1),
(7, 'carousel-slides', 'json', 
'[
  {
    "imageId": 7,
    "date": "June 20, 2025",
