  ...
  return (
    <div className="flex flex-col md:flex-row h-[400px] justify-center">     
      ...
      <div className="w-full md:w-1/3 flex flex-col justify-start p-8 md:text-left">
        <h1 className="text-4xl font-bold mb-4 text-black uppercase">We're proud of the support of our partners</h1>
        <button className="md:w-1/2 bg-blue-300 text-black font-bold px-2 py-2 rounded">
          Become a Partner
        </button>
      </div>
        ...
        <div className="embla h-full" ref={emblaRef}>
          <div className="embla__container flex">
            {slides.map((slide, index) => (
              <div className="min-w-full flex flex-col items-center justify-center p-6" key={index}>
                <img src={slide.img} alt={`Slide ${index}`} className="w-72 h-44 object-cover rounded mb-4" />
