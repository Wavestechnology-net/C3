      ...
      <div className="px-3 py-12 md:px-40">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              <h3 className="text-lg font-bold mb-1">
                <a
                  href="https://www.C3 SOCCERSsc.org/recreational"
            ...
            <div>
              <h3 className="text-lg font-bold mb-1">
                <a
                  href="https://C3 SOCCERSsc.org/youth-academy"
                  className="text-[#d6226a] hover:underline"
                >
                  Youth Academy:
                </a>
            ...
            <div>
              <h3 className="text-lg font-bold mb-1">
                <a
                  href="https://www.C3 SOCCERSsc.org/competitive"
                  className="text-[#d6226a] hover:underline"
                >
                  Competitive:
                </a>
        ...
        {isSubmitSuccessful && (
          <div className="mt-6 p-4 bg-green-100 text-green-800 border border-green-200 rounded">
            ...
            C3 SOCCERS staff member will get back to you within 48 hours.
          </div>
        )}
