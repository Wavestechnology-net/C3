  ...
  return (
    <div className="w-full">
      ...
      <section className="w-full">
        <img
          src="https://cdn.prod.website-files.com/5eb043b98cf9c48746832cbb/64c03c20e7de177d5c3e3d07_C3 SOCCERS-elite-hero.jpg"
      ...
      <section className="bg-white text-center py-16 px-3 ">
        <div className="max-w-5xl mx-auto flex flex-col items-start space-y-4">
          <h1 className="text-4xl font-bold uppercase">C3 SOCCERS Elite</h1>
          <h2 className="text-lg font-semibold text-red-600">
            Birth Years: 2013 (U13) - 2008/07 (U18/19)
          </h2>
          <p className="text-base text-lg text-gray-700 text-left">
            C3 SOCCERS Elite is the highest competitive level of programming we
            offer. The Elite Program is incredibly rewarding but tremendously
            demanding. C3 SOCCERS Elites must demonstrate the highest level of
            ...
            teams are formed from the strongest players across our entire player
            pool and require a yearly commitment.
          </p>
          <p className="text-base text-lg text-gray-700 text-left">
            The Elite program at C3 SOCCERS consists of 3 leagues that sit at
            ...
            level national competition platforms for elite youth athletes in the
            ...
            maximize player opportunity and visibility. C3 SOCCERS Elite teams
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold uppercase">
              Why C3 SOCCERS Elite
            </h2>
            <p className="text-gray-800 text-lg">
              C3 SOCCERS will work relentlessly to be recognized as a top youth
              ...
              development along with an unparalleled environment, and support
              structure.
            </p>
            <p className="text-gray-800 text-lg">
              C3 SOCCERS dedicates significant resources to ensure that we
              ...
              management systems, and flexible cost structures to assist your
          ...
          <div className="relative -mt-10 md:-mt-10 z-10">
            <img
              src="https://cdn.prod.website-files.com/5eb043b98cf9c48746832cbb/64c03c25e7de177d5c3e419e_C3 SOCCERS-elite-1.jpg"
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-5xl mx-auto flex flex-col gap-10 items-start">
          {/* <div className="relative -mt-5 z-10">
                        <img
                            src="https://cdn.prod.website-files.com/5eb043b98cf9c48746832cbb/64c03bf9e7de177d5c3df82f_C3 SOCCERS-competitive-2.jpg"
          ...
          <div className="space-y-4">
            <h2 className="text-3xl font-bold uppercase">
              Elite Players C3 SOCCERS with us
            </h2>
            <div className="space-y-2 text-gray-700 text-lg">
              {[
                "Funded, U13 & U18/19 top boys ECNL teams and top Girls Academy teams ($0 Club Fee)",
                "50+ Professional and National Team players produced by C3 SOCCERS legacy clubs",
      ...
      <section className="bg-white">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 py-10 items-start">
          <img
            src="https://cdn.prod.website-files.com/5eb043b98cf9c48746832cbb/64c03cc43338f522fad758e1_C3 SOCCERS-elite-1-2.jpg"
            alt="Training"
            className="rounded-lg"
          />
          <div>
            <h1 className="text-3xl font-bold mb-4 uppercase">
              C3 SOCCERS offers Elite Program Players
            </h1>
            <div className="space-y-2 text-gray-700 text-lg">
              {[
      ...
      <section className="bg-[#96cfdc] h-auto md:h-[220vh] py-15 px-4 text-start">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid md:grid-cols-1/3 gap-15">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700 text-xl w-full ">
                The Girls Academy (GA) is a new, member-led league that
                currently includes 59 elite level clubs, including 45 former
                U.S. Soccer Girls’ DA clubs across the country. The GA consists
                of like-minded clubs who insist on a standard driven approach
                that enhances development for our players, coaches, and club.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700 text-xl w-full ">
                The Boys Elite Clubs National League (Boys - ECNL) was founded
                to improve the daily environment for boys youth soccer players
                through a collaborative club-based development program featuring
                competition, player identification, and coaching and club
                development platforms. The Boys ECNL will include both regular
                season conference games and cross-conference events, and
                qualifying teams from the Boys ECNL will advance to the
                postseason Elite National Premier League (ENPL) Playoffs.
              </p>
              <button className="bg-yellow-400 text-black px-4 py-2 rounded hover:bg-gray-800 w-fit">
                Learn More
              </button>
            ...
            <div className="space-y-4">
              <h3 className="text-3xl font-bold text-black uppercase">
                ECNL - Regional League - Boys (ECNL-RL)
              </h3>
              <h4 className="text-xl font-semibold text-red-600">
                Birth Years: 2013 (U13) - 2008/07 (U18/19)
              </h4>
              <p className="text-gray-700 text-xl w-full ">
                The ECNL Boys Regional League (ECNL Regional League) was founded
                to improve the daily environment for boy’s youth soccer players
                through a collaborative club-based development program featuring
                competition, player identification, and coaching and club
                development platforms. The Boys ECNLRegional League will include
                both regular season conference games and cross-conference
                events, and qualifying teams will advance to the ECNL
                RegionalLeague Post Season event, held in conjunction with the
                ECNL Boys Post Season.
              </p>
              <button className="bg-yellow-400 text-black px-4 py-2 rounded hover:bg-gray-800 w-fit">
                Learn More
              </button>
          ...
          <div className="relative">
            <img
              src="https://cdn.prod.website-files.com/5eb043b98cf9c48746832cbb/64c03cca3338f522fad7638f_C3 SOCCERS-elite-6.jpg"
              alt="Team Spirit"
