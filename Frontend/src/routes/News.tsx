...
const News: React.FC = () => {
  const newsItems = [
    {
      imageUrl:
        "https://cdn.prod.website-files.com/5ec2ed9690a5ba94fd8cdafb/6633aeda7a30e2733c964aae_C3 Soccer_college_commits_2024-p-500.jpg",
      category: "College Commitments",
      title: "2024 College Commitments",
      date: "May 2",
      description:
        "Congrats to our 2024 C3 Soccer Soccer Club College Commits!",
    },
    {
      imageUrl:
      ...
      category: "Partners",
      title:
        "C3 Soccer Introduces New Partnership with the Soccer Parenting Association",
      date: "September 29",
      description: "Youth soccer parents & coaches.",
    },
    {
      imageUrl:
        "https://cdn.prod.website-files.com/5ec2ed9690a5ba94fd8cdafb/65164b64d615fba83fd50375_C3 Soccer-72-p-500.jpg",
      category: "",
      title: "C3 Soccer Makes 3 Outstanding New Hires",
      date: "June 3",
      description:
        "C3 Soccer makes 3 outstanding new hires to enhance the player environment and maximize potential.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      category: "",
      title: "C3 Soccer Advanced: Player Referral Program",
      date: "April 2",
      description:
        "An exciting new Referral Program to help spread the word about your positive C3 Soccer experiences.",
    },
    {
      imageUrl:
      ...
      category: "",
      title: "C3 Soccer Recreational: Player Referral Program",
      date: "April 2",
      description:
        "Refer friends to C3 Soccer and help grow our community with your positive experiences.",
    },
    {
      imageUrl:
      ...
      category: "",
      title: "C3 Soccer U17 Boys Reach the Final 4",
      date: "March 30",
      description:
        "C3 Soccer U17 boys reach the final 4 of the National Academy Championships.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      date: "October 9",
      description:
        "Congrats to our 2023 C3 Soccer Soccer Club College Commits!",
    },
  ];
    ...
    <>
      ...
      <div className="mx-4 sm:mx-10 md:mx-20 lg:mx-40 xl:mx-80 my-8">
        ...
        <p>
          ...
          shared commitment between C3 Soccer Soccer Club and Reliant to grow
